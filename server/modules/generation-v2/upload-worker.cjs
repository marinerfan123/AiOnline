...
async function processUploadItem(pg,item,injected={}){
 ...
 const base={itemId:item.item_id,leaseVersion:Number(item.lease_version),workerId:item.lease_owner||injected.workerId};
