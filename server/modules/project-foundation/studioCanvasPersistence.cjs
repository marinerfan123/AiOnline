...
const EPHEMERAL_NODE_KEYS = new Set(['selected', 'dragging', 'hovered', 'resizing', 'measured', 'dragHandle', 'parentNode', 'extent', 'positionAbsolute']);
...
module.exports = { createStudioCanvasPersistence, normalizeNode, normalizeEdge, durableNodeData, LIMITS };
